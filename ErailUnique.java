...
public class ErailUnique {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//add to a set and get the size
		Set<String> TrainSet = new HashSet<String>();
		for (WebElement webelementset : element1) {

			String trainnames=webelementset.getText();
			TrainSet.add(trainnames);
			
		}
		
		System.out.println("Set size is " + TrainSet.size());
